...
<head>
    ...
    <!-- dataTables -->
    <link href="<?php echo base_url(); ?>assets/js/plugins/datatables/css/jquery.dataTables.min.css" type="text/css" rel="stylesheet">
</head>
<style type="text/css">
    .icon_style {
        position: absolute;
    ...
    <nav class="blue">
        <div class="nav-wrapper container">
            ...
            <ul class="side-nav" id="mobile-demo">
                <li><a href="<?php echo base_url(); ?>petugas"><i class="mdi-action-home" style="font-size: 30px"></i> Home</a></li>
                <li class="divider"></li>
                <li><a href="<?php echo base_url(); ?>barang/barang"><i class="mdi-editor-format-list-bulleted" style="font-size: 30px"></i> Barang</a></li>
                <li><a href="<?php echo base_url(); ?>penjualan/penjualan"><i class="mdi-editor-format-list-bulleted" style="font-size: 30px"></i> Penjualan</a></li>
                <li class="divider"></li>
                <li><a href="<?php echo base_url(); ?>petugas/profil"><i class="mdi-action-face-unlock" style="font-size: 30px"></i> Profil</a></li>
                <li><a href="<?php echo base_url(); ?>login/logout"><i class="mdi-hardware-keyboard-tab" style="font-size: 30px"></i> Logout</a></li>
            </ul>
        </div>
    </nav>
</body>
